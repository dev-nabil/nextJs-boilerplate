...
import { faqFormSchema, TFaqFormValues } from "@/schemas/faq";
...
export function CreateAndUpdateFaqForm({ id }: { id?: string }) {
  ...
  const { data: singleFaq, isLoading: isLoadingSingle } = useGetSingleFaqQuery(
    id ?? "",
    { skip: !id }
  );
  ...
  const onSubmit = async (values: TFaqFormValues) => {
    try {
      if (id) {
        ...
        toast.success(
          "FAQ created successfully! It's now available to help users."
        );
      }
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Write a clear, concise question that users commonly ask. Start
                  with question words like "How", "What", "Why", or "When".
                </p>
              </div>
          ...
          <Card className="border-0 bg-white shadow-sm">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500">
                  Provide a detailed, helpful answer. Use formatting to make it
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="mb-2 text-sm font-medium text-green-900">
                      Guidelines for effective answers:
                    </h4>
