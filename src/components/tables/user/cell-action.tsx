...
// ============permission===block=NID_verification===========
const NID_verificationPermission = checkAccess('seller', 'NID_verification').status
const blockPermission = checkAccess('seller', 'block').status
// ============permission===block=NID_verification===========
...
export default function CellAction({ data }: CellActionProps) {
  ...
  const handleBanToggle = async () => {
    try {
      ...
      toast.success(`User ${data.blocked ? 'unbanned' : 'banned'} successfully.`)
    ...
    <>
      <AlertModal
        ...
        description={`Are you sure you want to ${data.blocked ? 'unban' : 'ban'} this user? ${
          !data.blocked ? 'They will no longer be able to access the platform.' : 'This will restore their access to the platform.'
        }`}
      />
      {(NID_verificationPermission || blockPermission) && (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            {NID_verificationPermission && hasNid && (
