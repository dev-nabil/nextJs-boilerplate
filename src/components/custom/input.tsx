            ...
            <Popover>
              ...
              <PopoverContent className="w-auto p-0" align="start">
                <Calendar
                  ...
                  classNames={{
                    day_selected:
                      "bg-teal-500 text-primary-foreground hover:bg-teal-500 hover:text-primary-foreground",
                    day_today: date
            ...
            <ReactSelect
              ...
              onChange={(val) => {
                ...
                if (!val || val.length <= maxSelectionLimit) {
                  ...
                  setLocalError(
                    `You can select up to ${maxSelectionLimit} options.`
                  );
                }
            ...
            <>
              ...
              >
                <input
                  ...
                  name={name}
                  className={cn(
                    "absolute top-0 left-0 z-20 h-full w-full cursor-pointer opacity-0"
                  )}
                  placeholder={placeholder}
